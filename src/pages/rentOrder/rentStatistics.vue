        ...
        route: {
            data: function(transition){
                if(common.noLoginRedirect()){
                    var params = {
                        userId: '301',
                        countByDate: Date.parse(this.date)
                    }
                    commonAjax.ajaxGetJson(api.rentOrder.statistics, params, function(data){
            ...
            search: function() {
                ...
                if (!self.$validation.invalid) {
                    var params = {
                        ...
                        countByDate: Date.parse(self.date)
                    }
                    commonAjax.ajaxGetJson(api.rentOrder.statistics, params, function (data) {
                        self.$set('total', data);
                    });
